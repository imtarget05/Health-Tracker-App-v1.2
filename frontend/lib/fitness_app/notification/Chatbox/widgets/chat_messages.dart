...
import 'package:best_flutter_ui_templates/fitness_app/notification/Chatbox/widgets/assistant_message_widget.dart';
import 'package:best_flutter_ui_templates/fitness_app/notification/Chatbox/widgets/my_message_widget.dart';
...
class ChatMessages extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return message.role.name == Role.user.name
      ? MyMessageWidget(message: message, chatProvider: chatProvider, chatId: chatProvider.currentChatId)
