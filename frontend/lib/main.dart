...
Future<void> main() async {
  ...
  await PngControllerHelper().preloadPngFile('assets/images/doctor.png');
  await Future.wait([
  ...
  // Use Vietnamese for Firebase Auth emails (verification/reset)
  await FirebaseAuth.instance.setLanguageCode('vi');

  // Decide initial route synchronously to avoid late-set race conditions
